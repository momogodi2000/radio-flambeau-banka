...
const AudioPlayer = ({ isSticky = false, onClose }) => {
  ...
  const streamUrls = [
    import.meta.env.VITE_STREAM_URL_1 || 'https://radioflambeaubanka.radiostream321.com/stream',
    import.meta.env.VITE_STREAM_URL_2 || 'https://radioflambeaubanka.radio12345.com/stream',
    import.meta.env.VITE_STREAM_URL_3 || 'https://radioflambeaubanka.radiostream123.com/stream'
  ];

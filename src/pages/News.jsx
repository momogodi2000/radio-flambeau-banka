...
const News = () => {
  ...
  const newsItems = [
    {
      id: 1,
      title: "Radio Flambeau-Banka célèbre son 8ème anniversaire",
    ...
    {
      id: 2,
      title: "Lancement d'une nouvelle émission dédiée à la santé",
      excerpt: "Radio Flambeau-Banka lance une nouvelle émission hebdomadaire consacrée à la santé et au bien-être, animée par Dr. Marie Nguemo.",
      date: "2023-04-22",
      author: "Paul Tamo",
      image: "/images/programs/morning.jpg",
      category: "programmes",
      tags: ["santé", "émission", "bien-être"]
    },
    {
      id: 3,
      title: "Partenariat avec l'ONG Locale pour l'éducation",
      excerpt: "Radio Flambeau-Banka signe un partenariat avec l'ONG 'Éducation Pour Tous' pour promouvoir l'accès à l'éducation dans la région.",
      date: "2023-03-10",
      author: "Claire Nkodo",
      image: "/images/team/marie.jpg",
      category: "partenariats",
      tags: ["éducation", "ONG", "développement"]
    },
    {
      id: 4,
      title: "Couverture spéciale des élections municipales",
      excerpt: "Notre équipe se prépare à assurer une couverture complète des prochaines élections municipales avec des reportages en direct.",
      date: "2023-02-28",
      author: "Jean Kouam",
      image: "/images/team/jean-paul.jpg",
      category: "actualités",
      tags: ["élections", "politique", "reportage"]
    },
    {
      id: 5,
      title: "Festival de musique traditionnelle de Banka",
      excerpt: "Radio Flambeau-Banka était le partenaire média officiel du Festival de musique traditionnelle qui s'est tenu le week-end dernier.",
      date: "2023-01-20",
      author: "Marie Fotso",
      image: "/images/clovy.jpg",
      category: "culture",
      tags: ["musique", "tradition", "festival"]
    },
    {
      id: 6,
      title: "Rénovation des studios de Radio Flambeau-Banka",
      excerpt: "Nos studios ont été entièrement rénovés avec un équipement de pointe pour améliorer la qualité de nos émissions.",
      date: "2022-12-15",
      author: "Paul Tamo",
      image: "/images/qv1.jpg",
      category: "infrastructure",
      tags: ["rénovation", "technologie", "qualité"]
    }
  ];
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-blue-100">
                Restez informé des dernières nouvelles de Radio Flambeau-Banka
              </p>
            </motion.div>
          </div>
        </section>
